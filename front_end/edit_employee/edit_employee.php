...
<button class="back-btn" onclick="window.history.back()">Back</button>
    ...
    <div class="main-container">
        ...
        <div class="form-container bank">
            ...
            <form class="form" action="update_self.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="acc" name="acc" value="<?php echo $acc; ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="rout">Routing Number *</label>
                    <input type="text" id="rout" name="rout" value="<?php echo $rout; ?>" readonly>
                </div>
            </form>
        </div>
        ...
        <div class="form-container personal">
            <h1>Personal</h1>
            <form class="form" action="update_employee.php" method="post">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select id="role" name="role">
                        <option value="associate" <?php if($role == "associate") {echo "selected";}?>>Associate</option>
    ...
    <!-- Remove Employee Information Button -->
    <div class="remove-container">
        <form action="../hr_home/delete_employee.php" method="post">
            <?php echo "<input type=\"hidden\" name=\"e_ssn\" value=\"$ssn\">"; ?>
            <button type="submit" class="btn remove-btn">Remove Employee</button>
        <form>
    </div>
</body>
</html>